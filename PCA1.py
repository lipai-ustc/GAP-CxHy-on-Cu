...
for frame in frames_less:
  frames_features_less.append(desc.create(frame, n_jobs=8))
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.savefig("soap2.jpg",ppi=300)

os.system("convert -trim soap.jpg soap.jpg")
os.system("convert -trim soap2.jpg soap2.jpg")
